...
public class UpdaterJFrame extends JFrame {
	...
	private JComboBox<UnoWiFiFirmware> firmwareSelector;
	...
	public UpdaterJFrame() {
		setTitle("UnoWiFi Firmware Updater");
		setResizable(false);
		...
		firmwareSelector = new JComboBox<UnoWiFiFirmware>();
...
//	}
	...
	protected JComboBox<UnoWiFiFirmware> getFirmwareSelector() {

 ...
 */
package cc.arduino.plugins.unowifi;
...
//import cc.arduino.plugins.unowifi.firmwares.WINC1500Firmware;
import cc.arduino.plugins.unowifi.firmwares.UnoWiFiFirmware;
import cc.arduino.plugins.unowifi.flashers.Flasher;
//import cc.arduino.plugins.unowifi.flashers.java.JavaFlasher;
import cc.arduino.plugins.unowifi.flashers.cli.CLIFlasher;
...
public class UpdaterImpl extends UpdaterJFrame {
	...
	public UpdaterImpl() throws Exception {
		...
		for (UnoWiFiFirmware firmware : UnoWiFiFirmware.available)
...
//	}
	...
	protected void updateFirmware() {
		...
		UnoWiFiFirmware fw = (UnoWiFiFirmware) getFirmwareSelector().getSelectedItem();
		setEnabled(false);
		new Thread() {
			@Override
			public void run() {
